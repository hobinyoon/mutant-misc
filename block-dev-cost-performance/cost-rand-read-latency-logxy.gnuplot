...
set output "block-dev-cost-rand-read-latency-logxy.pdf"
...
set logscale xy
plot \
"data-cost-read" u 2:($3/1000):($7/1000):($13/1000):0 w yerrorbars pt 7 pointsize 0.3 lw LINE_WIDTH palette not, \
"data-cost-read" u 2:($3/1000):(strcol(1) ne "Local SSD" ? strcol(1) : "") w labels left  offset  0.7,0 not, \
"data-cost-read" u 2:($3/1000):(strcol(1) eq "Local SSD" ? strcol(1) : "") w labels right offset -0.7,0 not
