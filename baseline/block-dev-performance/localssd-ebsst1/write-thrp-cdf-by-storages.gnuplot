...
#set xtics nomirror tc rgb "black" font ",10" autofreq 0,50
#set xtics nomirror tc rgb "black" rotate by -30 autofreq 0,50
set xtics nomirror tc rgb "black" autofreq 0,100
set mxtics 2
