...
namespace Serial {
	...
	// Obj age starts either from the first write or from the beginning of the
	// traces. Not from the last update.
	//
	...
	// We set the last update time of an unseen object to the beginning of the
	// traces.
