...
class ClientLogReader:
	...
	def _ParseOptions(self, line):
		# # Quizup run script options: <Values at 0x7f92d7503c20:
		# {'simulation_time_dur_in_sec': '60000', 'db_path':
		# '/mnt/local-ssd1/rocksdb-data/quizup',
		# 'cache_filter_index_at_all_levels': 'true', 'workload_stop_at': '-1.0',
		# 'slow_dev2_path': None, 'evict_cached_data': 'true', 'fast_dev_path':
		# '/mnt/local-ssd1/rocksdb-data', 'upload_result_to_s3': True,
		# 'monitor_temp': 'false', 'exp_desc':
		# 'VW5tb2RpZmllZCBSb2Nrc0RCIGxhdGVuY3kgd2l0aCBhbmQgd2l0aG91dCBtZXRhZGF0YSBjYWNoaW5n',
		# 'init_db_to_90p_loaded': 'true', 'slow_dev1_path': None,
		# 'workload_start_from': '0.899', 'migrate_sstables': 'false',
		# 'sst_migration_temperature_threshold': None, 'slow_dev3_path': None,
		...
		if mo is not None:
			...
			#Cons.P(pprint.pformat(self.options))
	...
	def _ParseLatency(self, line):
		...
		simulated_time_95p = "160726-171724.123"
		if simulated_time < simulated_time_95p:
			return
