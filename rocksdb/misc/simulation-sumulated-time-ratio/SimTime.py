...
def Init(simulation_time_begin):
	with Cons.MT("Init Conf ...", print_time=False):
		...
		Cons.P("simulation_time_interval_in_sec: %11.3f" % (_simulation_time_end - _simulation_time_begin).total_seconds())
		Cons.P("simulated_time_interval_in_sec : %11.3f" % (_simulated_time_end - _simulated_time_begin).total_seconds())
		Cons.P("simulated_time_interval / simulation_time_interval: %f"
