...
y_max=      " 50  400    400    400    400    400    400   1300   1300   1300   1300    1300    1300    1300    1300    1300    1300    1300    1300    1300"
# metric_idx: 30 to 49
# metric_idx: 9 to 28
...
do for [i=1:20] {
	...
	if (i == 1) {
		set title "write latency: avg"
	} else {
		set title "Write latency: " . word(metric_name, i) . " percentile"
	}
