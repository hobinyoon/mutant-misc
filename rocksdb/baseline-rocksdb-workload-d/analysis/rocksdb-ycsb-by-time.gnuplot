...
if (1) {
  ...
  plot \
  IN_FN_DSTAT u 25:($16 == 0 ? 1/0 : $16) w p pt 7 ps PS lc rgb "red" t "write (red)", \
  IN_FN_DSTAT u 25:($15 == 0 ? 1/0 : $15) w p pt 7 ps PS lc rgb "blue" t "read (blue)"

  set ylabel "Local SSD IOPS\nfrom dstat"
  plot \
  IN_FN_DSTAT u 25:($14 == 0 ? 1/0 : $14) w p pt 7 ps PS lc rgb "red" t "write (red)", \
  IN_FN_DSTAT u 25:($13 == 0 ? 1/0 : $13) w p pt 7 ps PS lc rgb "blue" t "read (blue)"
}
