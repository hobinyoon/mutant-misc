...
if (1) {
  ...
  set label 1 at screen 0.025, screen 0.90 PARAMS font "DejaVu Sans Mono,10" left front
...
if (1) {
  ...
  set xlabel "Time (HH:MM)"
  set ylabel "EBS st1 Read, Write (MiB/sec)"
  set xtics nomirror tc rgb "black"
  set ytics nomirror tc rgb "black"
  set grid xtics ytics back lc rgb "#808080"
  set border back lc rgb "#808080" back
...
if (1) {
  ...
  set xlabel "Time (HH:MM)"
  set ylabel "EBS st1 Read, Write (IOPS)"
  set xtics nomirror tc rgb "black"
  set ytics nomirror tc rgb "black"
  set grid xtics ytics back lc rgb "#808080"
  set border back lc rgb "#808080" back
